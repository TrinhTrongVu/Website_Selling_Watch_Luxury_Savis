...
import com.watchluxury.model.request.CreateOrderRequest;
import com.watchluxury.model.request.UpdateDetailOrder;
import com.watchluxury.model.request.UpdateStatusOrderRequest;
...
import com.watchluxury.repository.StatisticRepository;
import com.watchluxury.service.OrderService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void updateDetailOrder(UpdateDetailOrder updateDetailOrder, long id, long userId) {
        ...
        if (updateDetailOrder.getCouponCode() != "") {
            ...
            UsedPromotion usedPromotion = new UsedPromotion(updateDetailOrder.getCouponCode(), promotion.getDiscountType(), promotion.getDiscountValue(), promotion.getMaximumDiscountValue());
